...
from ado_swarm.agents.software_engineer.main import build_agent
...
async def run_eval(model_profile: str = "fake") -> dict:
    ...
    task = TaskSpec(
        run_id="eval-run",
        title="Evaluate Software Engineer",
        objective="Run deterministic isolated evaluation for Software Engineer.",
