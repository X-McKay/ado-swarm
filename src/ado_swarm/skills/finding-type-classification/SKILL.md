...
description: Classify findings by scanner, vulnerability class, dependency, SAST, secret, IaC, or policy category.
...
Classify findings by scanner, vulnerability class, dependency, SAST, secret, IaC, or policy category.
...
Return concise findings suitable for inclusion in `AgentResult`, casefile sections, and task audit events. Include activated skill name `finding-type-classification` in audit metadata.
