...
description: Mine repeated false-positive patterns and propose detection or triage improvements.
...
Mine repeated false-positive patterns and propose detection or triage improvements.
...
Return concise findings suitable for inclusion in `AgentResult`, casefile sections, and task audit events. Include activated skill name `false-positive-pattern-mining` in audit metadata.
