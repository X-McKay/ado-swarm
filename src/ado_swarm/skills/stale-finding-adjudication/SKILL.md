...
description: Determine whether a finding is stale, already fixed, moved, or no longer applicable.
...
Determine whether a finding is stale, already fixed, moved, or no longer applicable.
...
Return concise findings suitable for inclusion in `AgentResult`, casefile sections, and task audit events. Include activated skill name `stale-finding-adjudication` in audit metadata.
