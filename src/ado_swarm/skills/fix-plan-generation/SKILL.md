...
description: Generate bounded implementation steps, required checks, rollback notes, and stop conditions.
...
Generate bounded implementation steps, required checks, rollback notes, and stop conditions.
...
Return concise findings suitable for inclusion in `AgentResult`, casefile sections, and task audit events. Include activated skill name `fix-plan-generation` in audit metadata.
