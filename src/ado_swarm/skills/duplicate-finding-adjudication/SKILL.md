...
description: Group duplicate or related findings and identify a canonical remediation case.
...
Group duplicate or related findings and identify a canonical remediation case.
...
Return concise findings suitable for inclusion in `AgentResult`, casefile sections, and task audit events. Include activated skill name `duplicate-finding-adjudication` in audit metadata.
