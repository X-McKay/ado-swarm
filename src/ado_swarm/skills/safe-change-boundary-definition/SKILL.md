...
description: Define allowed files, packages, commands, branches, and mutation boundaries for a fix.
...
Define allowed files, packages, commands, branches, and mutation boundaries for a fix.
...
Return concise findings suitable for inclusion in `AgentResult`, casefile sections, and task audit events. Include activated skill name `safe-change-boundary-definition` in audit metadata.
