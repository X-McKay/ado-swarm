...
description: Select the safest remediation strategy based on finding type, evidence, and policy.
...
Select the safest remediation strategy based on finding type, evidence, and policy.
...
Return concise findings suitable for inclusion in `AgentResult`, casefile sections, and task audit events. Include activated skill name `remediation-strategy-selection` in audit metadata.
